...
const { InvalidTokenError, InvalidAccessTokenError } = require("../errors/admin_errors");
...
const authentication = async (req, res, next) => {
  try {
    ...
    if (data.auth_client_id != "admin") {
      logger.info('Unauthorized action attempt by a user who is not an Admin.');
