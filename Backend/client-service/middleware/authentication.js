...
const { InvalidTokenError, InvalidAccessTokenError } = require("../errors/errors");
...
const authentication = async (req, res, next) => {
  try {
    ...
    if (data.auth_client_id != "client") {
      logger.info('Unauthorized action attempt by a user who is not a Client.');
